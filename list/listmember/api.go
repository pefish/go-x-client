...
import (
	...
	"github.com/pefish/go-x-client/list/listmember/types"
)
...
func ListMemberships(ctx context.Context, c *go_x_client.Client, p *types.ListMembershipsInput) (*types.ListMembershipsOutput, error) {
