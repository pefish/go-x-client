...
import (
	...
	"github.com/pefish/go-x-client/space/spacelookup/types"
)
...
func ListByCreatorIDs(ctx context.Context, c *go_x_client.Client, p *types.ListByCreatorIDsInput) (*types.ListByCreatorIDsOutput, error) {
...
func ListBuyers(ctx context.Context, c *go_x_client.Client, p *types.ListBuyersInput) (*types.ListBuyersOutput, error) {
