...
import (
	...
	"github.com/pefish/go-x-client/tweet/retweet/types"
)
...
func ListUsers(ctx context.Context, c *go_x_client.Client, p *types.ListUsersInput) (*types.ListUsersOutput, error) {
