...
import (
	...
	"github.com/pefish/go-x-client/tweet/timeline/types"
)
...
func ListTweets(ctx context.Context, c *go_x_client.Client, p *types.ListTweetsInput) (*types.ListTweetsOutput, error) {
...
func ListMentions(ctx context.Context, c *go_x_client.Client, p *types.ListMentionsInput) (*types.ListMentionsOutput, error) {
...
func ListReverseChronological(ctx context.Context, c *go_x_client.Client, p *types.ListReverseChronologicalInput) (*types.ListReverseChronologicalOutput, error) {
